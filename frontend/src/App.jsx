...
const styles = {
  ...
  appTitle: { fontSize: "1.25rem", fontWeight: "700", color: "#f8fafc" },
  appBadge: { fontSize: "0.75rem", color: "#38bdf8", fontWeight: "500", display: "block" },
  statusIndicator: {
    display: "flex",
    alignItems: "center",
    gap: "8px",
  ...
  statusText: { fontSize: "0.8rem", color: "#cbd5e1" },
  container: { maxWidth: "1100px", margin: "24px auto", padding: "0 16px", flex: 1, width: "100%" },
  grid: {
    display: "grid",
